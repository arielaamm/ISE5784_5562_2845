...
public class LightsTests {
   ...
   public void sphereDirectional() {
      ...
      camera1.setImageWriter(new ImageWriter("lightSphereDirectional2", 500, 500))
         .build()
         .renderImage()
         .writeToImage();
   }
   ...
   public void spherePoint() {
      ...
      camera1.setImageWriter(new ImageWriter("lightSpherePoint2", 500, 500))
         .build()
         .renderImage()
         .writeToImage();
   }
   ...
   public void sphereSpot() {
      ...
      camera1.setImageWriter(new ImageWriter("lightSphereSpot2", 500, 500))
         .build()
         .renderImage()
         .writeToImage();
   }
   ...
   public void trianglesDirectional() {
      ...
      camera2.setImageWriter(new ImageWriter("lightTrianglesDirectional2", 500, 500)) //
         .build()
         .renderImage()
         .writeToImage();
   }
   ...
   public void trianglesPoint() {
      ...
      camera2.setImageWriter(new ImageWriter("lightTrianglesPoint2", 500, 500)) //
         .build() //
         .renderImage() //
         .writeToImage(); //
   }
   ...
   public void trianglesSpot() {
      ...
      camera2.setImageWriter(new ImageWriter("lightTrianglesSpot2", 500, 500))
         .build()
         .renderImage()
         .writeToImage();
   }
   ...
   public void sphereSpotSharp() {
      ...
      camera1.setImageWriter(new ImageWriter("lightSphereSpotSharp2", 500, 500))
         .build()
         .renderImage()
         .writeToImage();
   }
   ...
   public void trianglesSpotSharp() {
      ...
      camera2.setImageWriter(new ImageWriter("lightTrianglesSpotSharp2", 500, 500))
         .build()
         .renderImage()
         .writeToImage();
   }
   ...
   public void sphereMultipleLight() {
      ...
      camera1.setImageWriter(new ImageWriter("sphereMultipleLight2", 500, 500))
              .build()
              .renderImage()
              .writeToImage();
   }
   ...
   public void trianglesMultipleLight() {
      ...
      camera2.setImageWriter(new ImageWriter("trianglesMultipleLight2", 500, 500))
              .build()
              .renderImage()
              .writeToImage();
   }
